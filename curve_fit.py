...
def prepare_stats(num):
    ...
    axs[0].set_title("100 e-children in age range 2;6-3;0 with $µ_{IARC}=$0.4 and $σ_{IARC}=$0.178")
    ...
    axs[1].set_title("100 e-children in age range 3;0-3;6 with $µ_{IARC}=$0.64 and $σ_{IARC}=$0.43")
    # plt.legend(loc="upper left")
    # plt.xlabel('Data')
    ...
    axs[2].set_title("100 e-children in age range 3;6-4;0 with $µ_{IARC}=$0.9 and $σ_{IARC}=$0.179")
